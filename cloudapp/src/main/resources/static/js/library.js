class VideoStreamClient{
    ...
    getServerUrl() {
        ...
        //return "wss://" + this.hostname + ":" + this.port + this.endpoint;
        // check java app's route to public address

       //return "ws://" + "192.168.0.102" + ":" + this.port + this.endpoint;
   }
...
class Drone {
    constructor(id, lat, lng) {
        ...
        this.lat = lat;
        this.lng = lng;
        this.videoSocket = new VideoStreamClient(id, PUBLIC_IP, 90, VIDEO_ENDPOINT);
